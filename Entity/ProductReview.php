 ...
 * @ORM\Entity(repositoryClass="Plugin\ProductReviewReplyable\Repository\ProductReviewRepository")
 */
class ProductReview extends AbstractEntity
{
    ...
    /**
     * @var \Plugin\ProductReviewReplyable\Entity\ProductReviewStatus
     *
     * @ORM\ManyToOne(targetEntity="Plugin\ProductReviewReplyable\Entity\ProductReviewStatus")
     * @ORM\JoinColumns({
    ...
    /**
     * @return \Plugin\ProductReviewReplyable\Entity\ProductReviewStatus
     */
    ...
    /**
     * @param \Plugin\ProductReviewReplyable\Entity\ProductReviewStatus $status
     */
    public function setStatus(\Plugin\ProductReviewReplyable\Entity\ProductReviewStatus $Status)
    {
        $this->Status = $Status;
    }
